...
for col in data_columns:
    ...
    # cols with special replacement values
        ...
        df[col].replace(to_replace = ['TRIMS reference', 'List of prohibited PRs', 'No'], value = [-1, -1, 0], inplace=True)
        ...
        df[col].replace(to_replace = ['Provides express or implied consent', 'Requires case-by-case consent'], value = [-1, 1], inplace=True)
        ...
        df[col].replace(to_replace = ['5 years', '10 years', '15 years', '20 years', 'Other', 'Indefinite'], value = [1, -1, -1, -1, 0, -1], inplace=True)
